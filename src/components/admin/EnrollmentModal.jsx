...
const EnrollmentModal = ({ isOpen, onClose, onSuccess, course }) => {
    ...
    const [confirmModal, setConfirmModal] = useState({ isOpen: false, enrollmentId: null });

    const handleRemoveClick = (enrollmentId) => {
        setConfirmModal({ isOpen: true, enrollmentId });
    };
    ...
    const confirmRemove = async () => {
        ...
        try {
            ...
            setConfirmModal({ isOpen: false, enrollmentId: null });
        } catch (error) {
    ...
    return (
        <>
                                ...
                                <div className="space-y-3">
                                    {enrollments.map((enrollment) => (
                                        <div key={enrollment.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg border border-gray-100">
                                            ...
                                            <button
                                                onClick={() => handleRemoveClick(enrollment.id)}
            ...
            <ConfirmationModal
                ...
                message="Are you sure you want to remove this student from the course? They will lose access to all course materials."
